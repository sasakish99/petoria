        ...
        <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-slate-50">
            ...
            >
                ...
                <form onSubmit={submitForm} className="space-y-6">
                    {/* Name */}
                    <div>
                        <label className="block font-bold text-sm text-slate-700 mb-2 ml-1" htmlFor="name">
                            お名前
                        </label>
                        <input
                            id="name"
                    ...
                    {/* Confirm Password */}
                    <div>
                        <label className="block font-bold text-sm text-slate-700 mb-2 ml-1" htmlFor="passwordConfirmation">
                            パスワード（確認）
                        </label>
                        <input
                    ...
                    <div className="flex items-center justify-center mt-6">
                        ...
                        >
                            既にアカウントをお持ちの方は <span className="text-slate-800 underline underline-offset-4 decoration-2">ログイン</span>
                        </Link>
                    </div>
                </form>
            </div>
